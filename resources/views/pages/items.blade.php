		...
		<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
			...
			<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
				...
				<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
					...
					<!--end::Item-->
					<!--begin::Item-->
					<li class="breadcrumb-item text-muted">Get Data</li>
					<!--end::Item-->
					<!--begin::Item-->
					<li class="breadcrumb-item">	<span class="bullet bg-gray-200 w-5px h-2px"></span>
					</li>
					<!--end::Item-->
					<!--begin::Item-->
					<li class="breadcrumb-item text-dark">Filter</li>
					<!--end::Item-->
				</ul>
				<!--end::Breadcrumb-->
			</div>
			...
			<div class="d-flex align-items-center py-1">
                ...
                <table>
							...
							<tr id="filters">
								...
								<th class="min-w-125px">Item Number</th>
								<th class="min-w-125px">Packaging</th>
		...
		<div id="kt_content_container" class="container-xxl">
			...
			<div class="card">
				...
				<div class="card-body pt-0">
					<!--begin::Table-->
					<table class="table align-middle table-row-dashed fs-6 gy-5" id="itemList">
						<!--begin::Table head-->
						<thead>
							<!--begin::Table row-->
                       ...
                       // echo "<pre>"; print_r($list);?>
						<tbody class="fw-bold text-gray-600">@foreach ($list as $i)
							<tr>
								<!--begin::Checkbox-->
								<td>{{ $i->item_name }}</td>
								<td>{{ $i->item_number }}</td>
