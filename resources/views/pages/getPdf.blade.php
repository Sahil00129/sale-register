	...
	<div class="toolbar" id="kt_toolbar">
		...
		<div id="kt_toolbar_container" class="container-xxl d-flex flex-stack">
			...
			<div class="d-flex align-items-center py-1">
                ...
                <form class="form-inline" method="post" action="{{  URL::to('/generate-pdf') }}" id="filterSale">

				@csrf <!-- {{ csrf_field() }} -->

                <label for="date">From</label>

                <input type="date" id="fromDate" placeholder="" name="fromDate" required>

                 <label for="date">To</label>  <input type="date" id="toDate" placeholder="Enter email" name="toDate" required>
                ...
                <select id="igroup" name="group" required>
                ...
                <select id="ipacking" name="packing" required>
