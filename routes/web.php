...
Route::get('items', 'ImportExportController@list');
Route::get('saledata', 'ImportExportController@saledata');
Route::get('purchasedata', 'ImportExportController@purchasedata');
Route::get('getPdf', 'ImportExportController@getpdf');
Route::get('bulkpdf', 'ImportExportController@bulkpdf');
Route::post('filter', 'ImportExportController@getDateFilter')->name('filter');
Route::post('filter-items', 'ImportExportController@getItemsofgroup');
Route::any('/generate-pdf', [PDFController::class, 'generatePDF']);
Route::any('/generate-allinone-pdf', [PDFController::class, 'allinone']);
Route::get('sales-data-request', 'AjaxController@getServerSide');
